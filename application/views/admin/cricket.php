...
<div class="page-content">
    ...
    <div class="row">
        <div class="slider4">
        <?php $i =1; foreach($MatchList   as $value){ ?>
    ...
    echo "class='dashboard-stat yellow  slide' ";
						...
						<a class="more" href="javascript:void(0)"  onclick="MatchDetailValues('<?php echo $value->unique;  ?>','<?php echo $value->id;  ?>');">
    ...
    <div class="btn-group btn-group btn-group-justified" id="MatchPanelContener" style="padding:0% 10% 1% 9%;">
   <div class="btn-group">
...
function MatchDetailValues(MatchKey, MatchIdValue)
{
	$('#MatchPanelContener').show();
	
	$.ajax({
	type: "POST",
	url: "<?php echo base_url(); ?>" + "index.php/cricketcontroller/GetUniqueMatchKey",
	dataType: 'json',
	data: {key: MatchKey},
	success: function(res) {

	//alert(res[0].id+" "+res[0].team_a);
	//$("#teama").html(res[0].id);
	var i = 0;
	if(res[0].toss_win=="a")
	{
	...
	if(res[0].toss_win=="b")
	{
	  ...
	  $("#teamb").text(res[0].team_b);
	}
	else
	{
	  $("#teamb").text(res[0].team_a);
	}*/
...
// End of Toss Ajax
var IningFristBallTeamValue = "1st_ball_team1";
$.ajax({
	type: "POST",
	url: "<?php echo base_url(); ?>" + "index.php/cricketcontroller/GetMatchFirstBallData",
	dataType: 'json',
	data: {MatchId: MatchIdValue, IningFristBallTeam: IningFristBallTeamValue},
	success: function(res) {
