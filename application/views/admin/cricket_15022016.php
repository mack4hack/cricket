...
<div class="page-content">
    ...
    echo "class='dashboard-stat yellow  slide' ";
						...
						<a class="more" href="javascript:void(0)"  onclick="MatchDetailValues('<?php echo $value->unique;  ?>');">
...
function MatchDetailValues(MatchKey)
{
	...
	$.ajax({
	type: "POST",
	url: "<?php echo base_url(); ?>" + "index.php/Admin/GetUniqueMatchKey",
	dataType: 'json',
	data: {key: MatchKey},
