...
*/
$config['tables']['users']           = 'user_master';
...
$config['identity']                   = 'user_code';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
