...
$CheckedMatchKey = $this->Admin_model->getCheckUniqueMatchIdPresentInMatchDetails($MatchUniqueKey);
if($CheckedMatchKey == ""){

$this->Admin_model->MatchDetailsInsert($ArrayOfMatchDetails);

}

$DataDetail['MatchDetails'] = $this->Admin_model->getMatchDetails($MatchUniqueKey);
...
if (!empty($MatchData)) {
	...
	foreach($MatchData as $v)
	{
		...
		$CheckedMatchKey = $this->Admin_model->getCheckUniqueMatchIdPresent($v->key);
...
if (!empty($MatchData)) {
	...
	foreach($MatchData as $v)
	{
		...
		$this->Admin_model->MatchListInsert($ArrayOfMatchList);
        $Data['MatchList'] = $this->Admin_model->getMatchList();
